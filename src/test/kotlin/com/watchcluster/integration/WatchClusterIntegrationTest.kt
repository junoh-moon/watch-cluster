...
import com.watchcluster.service.*
...
class WatchClusterIntegrationTest {
    ...
    @Test
    fun `end-to-end image version checking with semver strategy`() = runBlocking {
    ...
    @Test
    fun `end-to-end image checking with latest strategy`() = runBlocking {
        // Given
    ...
    @Test
    fun `end-to-end no update when current is latest version`() = runBlocking {
        // Given
    ...
    @Test
    fun `integration test with version lock major strategy`() = runBlocking {
        // Given
        val currentImage = "nginx:1.20.0"
    ...
    @Test
    fun `integration test with private registry and authentication`() = runBlocking {
        // Given
    ...
    @Test
    fun `integration test handles registry errors gracefully`() = runBlocking {
        // Given
        val currentImage = "nginx:1.20.0"
