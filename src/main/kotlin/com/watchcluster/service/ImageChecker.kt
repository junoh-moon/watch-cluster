...
class ImageChecker(
    ...
    private suspend fun extractDockerAuth(
        namespace: String,
    ...
    private suspend fun checkVersionUpdate(
        ...
        val versionComparison =
            findBestVersionMatch(imageComponents, strategy, dockerAuth)
    ...
    private fun normalizeVersionTag(
        originalTag: String,
        hasVPrefix: Boolean,
    ): String =
        when {
    ...
    private suspend fun checkLatestUpdate(
        currentImage: String,
        dockerAuth: DockerAuth?,
        namespace: String?,
    ...
    private suspend fun getAvailableTags(
        registry: String?,
        repository: String,
        dockerAuth: DockerAuth?,
    ): List<String> =
